...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const btnSimulado = document.querySelector('.card .btn-quiz-start');
    const btnsEstudar = document.querySelectorAll('.card .btn-estudar');
